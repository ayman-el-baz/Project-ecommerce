...
import ConseilSlider from '../Slider/ConseilSlider';
...
export default function Home() {
  ...
  useEffect(() => {
    !window.localStorage.getItem("userId") && navigate('/connexion')   
  }, [navigate])
  return (
    <Layout>
      <nav className="flex flex-col md:flex-row justify-between items-center p-4 md:h-20 z-10">
        <form class="mx-8 w-screen">
